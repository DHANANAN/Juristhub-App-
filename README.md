...
> A native Android shell for [dhananan.github.io/JuristHub](https://dhananan.github.io/JuristHub/) — surfaces JuristHub essays, projects, and research on the go.
...
| **Loads** | `https://dhananan.github.io/JuristHub/` |
| **Site repo** | [DHANANAN/JuristHub](https://github.com/DHANANAN/JuristHub) |

## Latest release

| File | Size | Path |
| --- | --- | --- |
| App Bundle (Play Store) | 4.06 MB | [`releases/JuristHub-v1.00-release.aab`](releases/JuristHub-v1.00-release.aab) |
| Side-load APK | 4.66 MB | [`releases/JuristHub-v1.00-release.apk`](releases/JuristHub-v1.00-release.apk) |
...
│           ├── mipmap-{m,h,x,xx,xxx}hdpi/  PNG launcher icons
...
- **Surface**: `#141D2E` · **Border**: `#1E3254`
- **Accent**: `#D4AF37` (gold) · `#E8C97A` (gold highlight)
- **Text**: `#EEF3F9` · `#C8DDF0` · `#8AA0BA`

Launcher icon: gold serif **J** on navy, with rounded-square + circular masks via adaptive icon system.
...
If `keystore.properties` is missing, the release build falls back to unsigned — useful for CI / clean clones, but the resulting APK won't install.
...
Register this fingerprint with any service that needs it (Firebase, Google Sign-In, Maps, Play App Signing).

## Permissions

| Permission | Reason |
| --- | --- |
| `INTERNET` | WebView loads the JuristHub site |
...
The site loaded by this app hosts the legal documents required by Google Play:
...
- Postal: JuristHub, c/o Dhananjay Chouhan, Indore, Madhya Pradesh, India
